"""
Author: Yixuan Su
Date: 2025/02/19 23:17
File: Open3D 实现坡度滤波算法.py
Description: 
...
if __name__ == '__main__':
    ...
    # -----------------------调用坡度滤波函数------------------------
    filtered_cloud = slope_filter(pcd, grid_step, elevation_difference_threshold, slope_threshold)
    o3d.io.write_point_cloud("slope_ground.pcd", filtered_cloud)
